...
public class MainContentMovieHolder extends RecyclerView.ViewHolder implements BaseViewHolder<StreamItemCluster> {
    ...
    private MainContentMovieHolder(Fragment fragment, View itemView) {
        super(itemView);
        ...
        title.setText(this.mFragment.getActivity().getResources().getString(R.string.category_movie_text));
        title.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.ic_movie, 0, 0, 0);
        title.setCompoundDrawablePadding(5);

        createFlexWeightLayoutParams();
    }

    public static MainContentMovieHolder newInstance(ViewGroup parent, Fragment fragment) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recommend_layout,
                parent, false);
        return new MainContentMovieHolder(fragment, view);
    }
