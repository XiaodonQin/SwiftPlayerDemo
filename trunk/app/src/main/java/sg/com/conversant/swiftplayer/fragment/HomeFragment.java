...
import sg.com.conversant.swiftplayer.adapter.MainHomeAdapter;
...
public class HomeFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mMainHomeAdapter = new MainHomeAdapter(mActivity);
    ...
    private void setupAdapter() {
        if (mMainHomeAdapter != null) {
            mMainHomeAdapter.deleteContents();
...
//            mRecyclerView.setAnimation(fadeIn);
            ...
            mMainHomeAdapter.setHeaderItems(posters);
            mMainHomeAdapter.setContentItems(contents);
        }
    }
